			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Ana SAYFA Düzenle</h2>
					</header>

					<!-- start: page -->
						<form class="ecommerce-form action-buttons-fixed" action="{{ route("componenthomepost") }}" method="post" enctype="multipart/form-data">
                            @csrf
							<div class="row mt-2">
								<div class="col">
										...
										<div class="card-body">
											<div class="row">
												<div class="col-lg-2-5 col-xl-1-5">
													...
													<h2 class="card-big-info-title">Ana SAYFA Bilgileri</h2>
												...
												<div class="col-lg-3-5 col-xl-4-5">
													<div class="form-group row align-items-center pb-3">
														<h4>Başlık  </h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="baslik" value=""/>
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 1</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama1" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 2</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama2" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 3</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama3" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 4</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama4" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 5</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama5" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 6</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama6" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 7</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama7" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 8</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama8" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 9</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama9" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Acıklama 10</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="aciklama10" value=""  />
														</div>
													</div>
                                                    <div class="">
                                                        <h4>İçerik</h4>
                                                        <div id="">
                                                            <textarea id="example" style="height:600px;" class="form-control form-control-modern" name="icerik"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Resim</h4>
														<div class="">
															<input type="file" class="form-control form-control-modern" name="resim" value=""  />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Link</h4>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <select style="height: 60px; width:200px; text-align: center; font-size:16px;" id="renk" name="kategori" required>
                                                            ...
                                                            <option value="">Ana SAYFA Alan</option>
                                                        ...
                                                        <select style="height: 60px; width:200px; text-align: center; font-size:16px;" id="renk" name="kategori" required>
                                                            ...
                                                            <option value="">Hakkımızda Alan</option>
                                                            <option value="KategoriAlanı">Hakkımızda Alanı</option>
