			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Seo Ayarları</h2>
										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="{{ route("componestadd") }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Ana Sayfa İçeriğini Düzenle</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 150px;">
											...
											<thead>
												<tr>
													...
													{{-- <th width="8%">Resim</th> --}}
													<th width="10%">baslik</th>
													<th width="10%">açıklama1</th>
													<th width="10%">açıklama2</th>
													<th width="10%">açıklama3</th>
													<th width="10%">açıklama4</th>
													<th width="10%">açıklama5</th>
													<th width="10%">açıklama6</th>
													<th width="10%">açıklama8</th>
													<th width="10%">açıklama9</th>
													<th width="10%">açıklama10</th>
													<th width="10%">link</th>
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    @endif --}}
													<td><a href="{{ route("componenthomeedit",$s->id) }}"><strong>{{ $s->id}}</strong></a></td>
													<td>{{ $s->baslik}}</td>
													<td>{!! $s->aciklama1 !!}</td>
													<td>{!! $s->aciklama2 !!}</td>
													<td>{!! $s->aciklama3 !!}</td>
													...
													<td>{!! $s->aciklama9 !!}</td>
													<td>{!! $s->aciklama10 !!}</td>
													<td><a href=" {{ route("componenthomeedit",$s->id) }}"><button type="button" class="btn btn-danger">Düzenle</button></a></td>
                                                    <td>
                                                        <a href="{{ route("componentdelete",$s->id)}} " onclick="return confirm('Silmek istediğinize emin misiniz?')" >
