			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Sipariş #{{ $getir->id }} Detayları</h2>
							...
							<div class="col-xl-4 mb-4 mb-xl-0">
								...
								<div class="card card-modern">
									<div class="card-header">
										<h2 class="card-title">Genel Detaylar</h2>
									</div>
									<div class="card-body">
										<div class="form-row">
                    ...
                    @else
                    <form action="{{ route("saticiordersidpost",$getir->id) }}" class="order-details action-buttons-fixed" method="post">
                        @csrf
						<div class="row">
							<div class="col-xl-4 mb-4 mb-xl-0">
