			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Ürün Boyutları</h2>
										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="{{ route("katagoriekle") }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Kategori Ekle</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<tbody>
                                                ...
                                                <tr>
													...
													<td><a href="ecommerce-category-form.html"><strong>{{ $get->size }}</strong></a></td>
                                                    <td><a href="{{ route("sizedeletepost",$get->id) }}"onclick="return confirm('Silmek istediğinize emin misiniz?')"><button class="btn btn-danger">Sil</button></a></td>
													<td><a href="{{ route("ürünboyutedit",$get->id) }}"><button class="btn btn-success">Düzenle</button></a></td>
