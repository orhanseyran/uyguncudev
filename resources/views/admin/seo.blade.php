										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="{{ route("seoaddpage") }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Seo Ayarı Ekle</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 150px;">
											...
											<thead>
												<tr>
													...
													{{-- <th width="8%">Resim</th> --}}
													<th width="28%">Sayfa</th>
													<th width="35%">Meta Açıklama</th>
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $s->sayfa}}</td>
													<td>{!! $s->meta_açıklama !!}</td>
													<td><a href=" {{ route("seoedit",$s->id) }}"><button type="button" class="btn btn-danger">Düzenle</button></a></td>
                                                    <td>
                                                        <a href="{{ route("seodelete",$s->id)}} " onclick="return confirm('Silmek istediğinize emin misiniz?')" >
