		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					...
					<!-- start: page -->
					<form class="ecommerce-form action-buttons-fixed" action="{{ route("kategoriekle") }}" method="post" enctype="multipart/form-data">
                        @csrf
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Katagori</h2>
											...
											<div class="col-lg-3-5 col-xl-4-5">
                                                ...
                                                <div class="form-group row align-items-center mb-3">
													<label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Katagori İcon Giriniz</label>
													<div class="col-lg-7 col-xl-6">
														<input type="file" class="form-control form-control-modern" name="katagoriicon" value="" required />
