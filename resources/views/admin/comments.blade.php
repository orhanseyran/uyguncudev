			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Yorumlar</h2>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 150px;">
											...
											<thead>
												<tr>
                                                    ...
                                                    <th width="14%">Puanı</th>
													<th width="18%">Yorum</th>
													<th width="35%">Email</th>
													<th width="10%">Aktif - Pasif</th>
												</tr>
											</thead>
											<tbody>
                                                ...
                                                @foreach ($getir as $yorum )
												<tr>



													<td><a href="#"><strong>{{ $yorum->ad}}</strong></a></td>
                                                    <td>{{ $yorum->rating}}</td>
                                                    <td>{{ $yorum->icerik}}</td>
													<td>{{ $yorum->email}}</td>
                                                    @if ($yorum->active == 0)
                                                    <td><a href=" {{ route("yorumonay",$yorum->id) }}"><button type="button" class="btn btn-success">Aktif Yap</button></a></td>
                                                    @else
                                                    <td><a href=" {{ route("yorumbeklet",$yorum->id) }}"><button type="button" class="btn btn-danger">Pasif Yap</button></a></td>
                                                    @endif


                                                    <td><a href="{{ route("yorumreddet",$yorum->id)}}"><button type="button" class="btn btn-warning">Sil</button></a></td>
