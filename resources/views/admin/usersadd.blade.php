		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					...
					<!-- start: page -->
					<form class="ecommerce-form action-buttons-fixed" action="{{ route("registerpost") }}" method="post" enctype="multipart/form-data">
                        @csrf
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Kullanıcı Ekle</h2>
												<p class="card-big-info-desc">Oluşturmak İstediğiniz Kullanıcı Bilgilerini Giriniz</p>
											</div>
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center mb-3">
													<label style="font-size:18px;"  class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Kullanıcı Bilgilerini Giriniz</label>
													<div class="col-lg-12 col-xl-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="name" id="inputName" placeholder="Adınızı girin">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="inputEmail">Email:</label>
                                                            <input type="email" class="form-control" name="email" id="inputEmail" placeholder="Email adresinizi girin">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="inputPassword">Şifre:</label>
                                                            <input type="password" class="form-control" name="password" id="inputPassword" placeholder="Şifrenizi girin">
                                                        </div>
