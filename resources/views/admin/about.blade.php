											...
											<div class="row">
												...
												<div class="col-lg-3-5 col-xl-4-5">
													<div class="form-group row align-items-center pb-3">
														<h4>Sayfa Adı</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="baslik" value="{{ $tekAbout->baslik }}" required />
														</div>
													</div>
                                                    <div style="width: 100%" class="form-group row">
                                                        ...
                                                        <div class="">
                                                            <h4>İçerik</h4>
                                                            <div id="">
                                                                <textarea id="example" style="height:600px;" class="form-control form-control-modern" name="icerik">{!! $tekAbout->icerik !!} </textarea>
                                                            </div>
                                                    ...
                                                    <div class="form-group row pb-3">
                                                        ...
                                                        <div class="col-lg-7 col-xl-6">
                                                            <input id="tags" name='meta'  value='{!! $tekAbout->meta !!}' class="form-control" autofocus>
                                                    ...
                                                    <div class="form-group row pb-3">
                                                        ...
                                                        <div class="col-lg-7 col-xl-6">
                                                            <textarea name="meta_aciklama" id="" cols="30" rows="10">{!! $tekAbout->meta_aciklama !!}</textarea>
