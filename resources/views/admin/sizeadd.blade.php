			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Boyut Ad</h2>
					</header>

					<!-- start: page -->
					<form class="ecommerce-form action-buttons-fixed" action="{{ route("sizeaddpost") }}" method="post" enctype="multipart/form-data">
                        @csrf
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<p class="card-big-info-desc">Oluşturmak İstediğiniz Boyut Ad Veriniz</p>
											</div>
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center mb-3">
													<label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Boyut </label>
													<div class="col-lg-7 col-xl-6">
                                                        <label for="boyut">Boyut:</label>
                                                        <select id="boyut" name="size">
