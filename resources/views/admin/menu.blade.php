										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="{{ route("headeradd") }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Menu Ekle</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 150px;">
											...
											<thead>
												<tr>
													...
													{{-- <th width="8%">Resim</th> --}}
													<th width="10%">Logo</th>
													<th width="10%">menu1</th>
													<th width="10%">menu2</th>
													<th width="10%">menu3</th>
													<th width="10%">menu4</th>
													<th width="10%">menu5</th>
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    @endif --}}
													<td><a href="{{ route("headereditget",$s->id) }}"><strong>{{ $s->id}}</strong></a></td>
													<td><img style="width: 80px" src="resimler/{{ $s->logoimg }}" alt=""></td>
													<td>{!! $s->menu1 !!}</td>
													<td>{!! $s->menu2 !!}</td>
													<td>{!! $s->menu3 !!}</td>
													<td>{!! $s->menu4 !!}</td>
													<td>{!! $s->menu5 !!}</td>
													<td><a href=" {{ route("headereditget",$s->id) }}"><button type="button" class="btn btn-danger">Düzenle</button></a></td>
                                                    <td>
                                                        <a href="{{ route("headerdel",$s->id)}} " onclick="return confirm('Silmek istediğinize emin misiniz?')" >
