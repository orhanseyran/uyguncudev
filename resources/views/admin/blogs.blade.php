			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Bloglar</h2>
										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="{{ route("blogekle") }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Blog Ekle</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 150px;">
											...
											<thead><
												<tr>
													...
													<th width="8%">Resim</th>
													<th width="28%">Blog Adı</th>
													<th width="18%">Baslik</th>
													<th width="35%">Yayınlayan</th>
