			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Oluşturulan Özel Siparişler</h2>
										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												...
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="{{ route("sipariş") }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Özel Sipariş Oluştur</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-borderless table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 640px;">
											...
											<tbody>
                                                ...
                                                <tr>
													...
													<td><a href="ecommerce-orders-detail.html"><strong>{{ $get->sira }} </strong></a></td>

													<td><a href="ecommerce-orders-detail.html"><strong>{{ $get->ad }} - {{ $get->soyad}}</strong></a></td>
													<td>{{ $get->urun }}</td>
                                                    <td>{{ $get->alici }}</td>
                                                    <td>{{ $get->telefon}}</td>
                                                    <td>{{ $get->durum }}</td>
                                                    <td>
                                                        <a href="{{ route("siparissil", $get->id) }}" onclick="return confirm('Silmek istediğinize emin misiniz?')">
                                                            <button type="button" class="btn btn-danger">Sil</button>
                                                        </a>
                                                    </td>
													<td><a href="{{ route("siparisdüzen",$get->id) }}"><button type="button" class="btn btn-success">Düzenle</button></a></td>
												</tr>
