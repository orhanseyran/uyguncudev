			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Sipariş Düzenle</h2>

					</header>

					<!-- start: page -->
					<form class="ecommerce-form action-buttons-fixed" action="{{ route("siparisdüzenle",$get->id) }}" method="POST">
                        @csrf
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Sipariş Düzenle</h2>
												<p class="card-big-info-desc">Bu sayfada oluşturduğunuz siparişi düzenleyebilir ve dinamik işlemler yapabilirsiniz</p>
											</div>
												...
												<div class="shipping-fields-wrapper collapse show">
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-7 col-xl-6">
															<input type="text" class="form-control form-control-modern" name="ad" value="{{ $get->ad }}" required />
														</div>
													</div>
													<div class="form-group row align-items-center">
														<label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Soyad</label>
														<div class="col-lg-7 col-xl-6">
															<input type="text" class="form-control form-control-modern" name="soyad" value="{{ $get->soyad }}" required />
														</div>
													</div>
													...
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-7 col-xl-6">
															<input type="text" class="form-control form-control-modern" name="adres" value="{{ $get->adres }}" required />
														</div>
													</div>
													...
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-7 col-xl-6">
															<input type="text" class="form-control form-control-modern" name="sehir" value="{{ $get->sehir }}" required />
														</div>
													</div>
													<div class="form-group row align-items-center">
														<label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Posta kodu / ZIP</label>
														<div class="col-lg-7 col-xl-6">
															<input type="number" class="form-control form-control-modern" name="zip" value="{{ $get->zip }}" required />
														</div>
													</div>
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-7 col-xl-6">
															<select class="form-control form-control-modern" name="alici">
																<option value="{{ $get->alici }}">{{ $get->alici }}</option>
                                                                @foreach ($getir as $al )
                                                                <option value="{{ $al->email }}">{{ $al->email}}</option>
                                                            ...
                                                            <select class="form-control form-control-modern" name="urun">
                                                                <option value="{{ $get->urun }}">{{ $get->urun }}</option>
                                                    ...
                                                    <div class="form-group row align-items-center">
														<label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">{{ $get->durum }}</label>

														<div class="col-lg-7 col-xl-6">
															<select class="form-control form-control-modern" name="durum">
																<option value="{{ $get->durum }}">{{ $get->durum }}</option>
													...
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-7 col-xl-6">
															<input type="number" class="form-control form-control-modern" name="telefon" value="{{ $get->telefon }}" />
														</div>
													</div>
												</div>
											</div>
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
                                <div class="col-12 col-md-auto">
                                    <input type="submit" value="Güncelle" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1">
								</div>
							</div>
							...
							<div class="col-12 col-md-auto ms-md-auto mt-3 mt-md-0 ms-auto">
								<a href="#" class="delete-button btn btn-danger btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1">
									<i class="bx bx-trash text-4 me-2"></i> Siparişi Bitir Ve Sil
								</a>
							</div>
						</div>
					</form>
