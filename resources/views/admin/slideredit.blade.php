		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					...
					<!-- start: page -->
					<form class="ecommerce-form action-buttons-fixed" action="{{ route("sliderdüzen",$slider->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                                                ...
                                                <div class="col-lg-3-5 col-xl-4-5">
                                                    <div class="form-group row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-7 col-xl-6">
                                                            <input type="text" class="form-control form-control-modern" name="baslik" value="{{ $slider->baslik }}" required />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row align-items-center mb-3">
                                                        <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Slider içeriğini Gir</label>
                                                        <div class="col-lg-7 col-xl-6">
                                                            <input type="text" class="form-control form-control-modern" name="icerik" value="{{ $slider->icerik }}" required />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row align-items-center mb-3">
                                                        <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Slider Resmini Gir</label>
                                                        <div class="col-lg-7 col-xl-6">
                                                            <input type="file" class="form-control form-control-modern"  name="picture"  /> <br>

                                                        </div>
                                                        <img style="width: 400px;" src="/resimler/{{ $slider->picture }}" alt="resim"><br>
                                                    </div>
                                                    <div class="form-group row align-items-center mb-3">
                                                        <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Slider Buton Adı</label>
                                                        <div class="col-lg-7 col-xl-6">
                                                            <input style="width: 200px;" type="text" class="form-control form-control-modern" name="buton" value="{{ $slider->buton }}" required />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row align-items-center mb-3">
                                                        <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Slider Buton Linki</label>
                                                        <div class="col-lg-7 col-xl-6">
                                                            <input style="" type="text" class="form-control form-control-modern" name="butonlink" value="{{ $slider->butonlink }}" required />
                                                        </div>
                                                    </div>
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
								<button type="submit" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
									<i class="bx bx-save text-4 me-2"></i> Güncelle
								</button>
							</div>
							...
							<div class="col-12 col-md-auto ms-md-auto mt-3 mt-md-0 ms-auto">
								<a href="{{ route("slidersil",$slider->id) }}" class="delete-button btn btn-danger btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1">
									<i class="bx bx-trash text-4 me-2"></i> Slider Sil
								</a>
							</div>
						</div>
					</form>
