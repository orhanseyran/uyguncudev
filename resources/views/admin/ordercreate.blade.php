			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Sipariş Oluştur</h2>
					...
					<form class="ecommerce-form action-buttons-fixed" action="{{ route("siparispost") }}" method="POST">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Sipariş Oluştur</h2>
												<p class="card-big-info-desc">Bu sayfada dinamik olarak kişiye özel sipariş oluşturabilirsiniz oluşturduğunuz siparişler ilgili kullanıcının panelinde gözükücektir</p>
											</div>
													...
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-7 col-xl-6">
															<select class="form-control form-control-modern" name="alici">
																<option value="Alıcı Seç">Alıcı Email Seç</option>
                                                                @foreach ($getir as $al )
						...
						<div class="row action-buttons">
							...
							<div class="col-12 col-md-auto px-md-0 mt-3 mt-md-0">
								<a href="{{ route("oluşturulansiparişler") }}" class="cancel-button btn btn-light btn-px-4 py-3 border font-weight-semibold text-color-dark text-3">İptal</a>
							</div>
