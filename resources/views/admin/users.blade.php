										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="{{ route("register") }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Kullanıcı Ekle</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 150px;">
											...
											<thead>
												<tr>
                                                    ...
                                                    <th width="14%">Email Adresi</th>
													<th width="50%">Üye Yetkisi</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td><a href="{{ route("usr",$user->id)}}"><button type="button" class="btn btn-danger"> Kullanıcıyı Düzenle</button></a></td>
                                                    @else
                                                    <td><a href="{{ route("usersdelete",$user->id)}}"><button type="button" class="btn btn-warning">Kullanıcıyı Sil</button></a></td>
                                                    <td><a href="{{ route("usr",$user->id)}}"><button type="button" class="btn btn-danger"> Kullanıcıyı Düzenle</button></a></td>
                                                    @endif
