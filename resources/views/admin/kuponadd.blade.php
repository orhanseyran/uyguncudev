		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					...
					<!-- start: page -->
					<form class="ecommerce-form action-buttons-fixed" action="{{ route("kuponaddpost") }}" method="post">
                        @csrf
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<p class="card-big-info-desc">Eklemek İstediğiniz İndirim Kuponu Ayarlayın</p>
											</div>
											<div class="col-lg-3-5 col-xl-4-5">
                                                ...
                                                <div class="form-group row align-items-center mb-3">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="discount_percentage" value="" required />
													</div>
												</div>
