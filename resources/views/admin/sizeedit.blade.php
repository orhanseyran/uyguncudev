			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Ürün Boyutu</h2>
					</header>

					<!-- start: page -->
					<form class="ecommerce-form action-buttons-fixed" action="{{ route("katagoridüzenpost",$getir->id) }}" method="post">
                        @csrf
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Ürün Boyut Düzenle</h2>
												<p class="card-big-info-desc">Düzenlemek İstediğiniz Ürün Boyutuna Ad Veriniz</p>
											</div>
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center mb-3">
													<label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Ürün Boyut Düzenle</label>
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="size" value="{{$getir->katagoriname}}" required />
													</div>
												</div>
						...
						<div class="row action-buttons">
							...
							<div class="col-12 col-md-auto px-md-0 mt-3 mt-md-0">
								<a href="{{ route("katagoriliste") }}" class="cancel-button btn btn-light btn-px-4 py-3 border font-weight-semibold text-color-dark text-3">İptal</a>
							</div>
