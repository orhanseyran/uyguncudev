			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Portfolyo</h2>
								...
								<div class="card-body">
									<div class="datatables-header-footer-wrapper">
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="{{ route("portfolyoadd") }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Portfolyo Ekle</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 150px;">
											...
											<thead>
												<tr>
													<th width="20%"><input type="checkbox" name="select-all" class="select-all checkbox-style-1 p-relative top-2" value="" /></th>
													{{-- <th width="8%">Resim</th> --}}
													<th width="28%">Portfolyo Adı</th>
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $s->baslik}}</td>
													<td>{!! $s->icerik !!}</td>
													<td><a href=" {{ route("portfolyodit",$s->id) }}"><button type="button" class="btn btn-danger">Düzenle</button></a></td>
                                                    <td>
                                                        <a href="{{ route("portfolyodel",$s->id)}} " onclick="return confirm('Silmek istediğinize emin misiniz?')" >
