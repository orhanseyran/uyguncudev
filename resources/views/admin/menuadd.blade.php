		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body content-body-modern mt-0">
					...
					<!-- start: page -->
						<form class="ecommerce-form action-buttons-fixed" action="{{ route("headerpost") }}" method="post" enctype="multipart/form-data">
                            @csrf
							<div class="row mt-2">
								<div class="col">
											...
											<div class="row">
												...
												<div class="col-lg-3-5 col-xl-4-5">
													<div class="form-group row align-items-center pb-3">
														<h4>Menu 1 </h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="menu1" value="" required />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Menu 2</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="menu2" value="" required />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Menu 3</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="menu3" value="" required />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Menu 4</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="menu4" value="" required />
														</div>
													</div>
                                                    <div class="form-group row align-items-center pb-3">
														<h4>Menu 5</h4>
														<div class="">
															<input type="text" class="form-control form-control-modern" name="menu5" value="" required />
														</div>
													</div>
